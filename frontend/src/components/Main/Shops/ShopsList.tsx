...
const ShopsList = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Магазины — TRC</title>
        <meta name="description" content="Список магазинов и модераторов на платформе TRC. Одежда и образы от разных продавцов." />
        <meta name="keywords" content="магазины, модераторы, продавцы, одежда, TRC" />
        <meta property="og:title" content="Магазины — TRC" />
        <meta property="og:description" content="Список магазинов и модераторов на платформе TRC." />
      </Helmet>
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <motion.div
