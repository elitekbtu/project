...
const Profile = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Профиль — TRC</title>
        <meta name="description" content="Ваш личный профиль на платформе TRC. Управление аккаунтом, настройками и историей покупок." />
        <meta name="keywords" content="профиль, аккаунт, настройки, TRC" />
        <meta property="og:title" content="Профиль — TRC" />
        <meta property="og:description" content="Ваш личный профиль на платформе TRC." />
      </Helmet>
      <motion.section
