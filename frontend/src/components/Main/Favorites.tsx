...
const Favorites = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Избранное — TRC</title>
        <meta name="description" content="Ваши избранные товары и образы на платформе TRC. Быстрый доступ к любимым вещам." />
        <meta name="keywords" content="избранное, любимое, товары, образы, TRC" />
        <meta property="og:title" content="Избранное — TRC" />
        <meta property="og:description" content="Ваши избранные товары и образы на платформе TRC." />
      </Helmet>
